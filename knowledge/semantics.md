...
9. Линковка деклов и боди пакетов
10. Проверка что в декле/боди пакета нет боди/декла подпрогр.
11. Проверка конфликта имен между деклом и боди пакета
12. Проверка доступности имен для типов и подпрог.
13. Замена типов-затычек в функции на указатель на реальный тип (совместно с 9)
14. Проверка указания своего типа в рекорде (совместно с 9 и 10)
15. Замена типов-затычек при наследование рекода (совместно с 9, 10 и 11)
16. Проверка окончаний подпрограм, типов, пакетов
17. Проверка переопределения перемен. в производных типах
18. Проверка перегрузки
19. Линковка декла и боди функций/процедур
20. Создания фул ооп класса из pack+type
21. Добавление классов в наследовании (c 15)
22. Добавление ссылки на класс в надклас. ссылки.
23. Проверка доступности имен в объявлениях и в коде (c 9 и с 23)
24. Замена типов-затычек в типах-массивах (c 9)
25. Замена типов-затычек в алиасах (c 9)
26. Замена типов-затычек в вардеклах (c 9)
27. Замена exrp на обращение к элементу массива
28. Замена expr на вызов функции
29. Замена expr массива и assign на присваивание
30. Замена expr на получение переменной
31. Замена expr получения аттрибута на вызов стандартной либы
32. Добавить указатель в for на нужный вардекл
33. Проверка типов
34. Проверка на наличие return в ф-ции
35. Проверка на lhs-out, и rhs-in
